    ...
    _createClass(Stopwatch, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { onClick: this.start.bind(this), id: "start" },
                    "Start"
                ),
                React.createElement(
                    "button",
                    { onClick: this.stop.bind(this), id: "stop" },
                    "Stop"
                ),
                React.createElement(
                    "button",
                    { onClick: this.reset.bind(this), id: "reset" },
                    "Reset"
                ),
                React.createElement(
                    "button",
                    { onClick: this.addToList.bind(this), id: "add-score" },
                    "Add score"
                ),
                React.createElement(
                    "button",
                    { onClick: this.eraseList.bind(this), id: "clear" },
                    "Clear scores"
                ),
                React.createElement(
                    "div",
